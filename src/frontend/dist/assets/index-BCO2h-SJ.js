...
function App() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "maintenance-root", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "maintenance-card", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "maintenance-heading", children: "We Have Moved" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "maintenance-body", children: "This website has moved to a new address. Please visit us at:" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "a",
      {
        ...
        children: "nirarebelhragency.com"
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "maintenance-note", children: "Thank you for your continued support — Nira Rebel HR Agency" })
  ] }) });
}
...
const Job = Record({
  "title": Text,
  "salary": Float64,
  "createdBy": Principal2,
  "description": Text,
  "requirements": Text,
  "location": Text
});
const DirectApplication = Record({
  "status": ApplicationStatus,
  "appliedAt": Int,
  "email": Text,
  "jobTitle": Text,
...
const StaffAccountInfo = Record({
  "userId": Text,
  "name": Text,
  "isActive": Bool
});
const StaffLoginResult = Record({
  "userId": Text,
  "name": Text
});
Service({
  "_initializeAccessControlWithSecret": Func([Text], [], []),
  "applyForJob": Func([Nat, Text], [Nat], []),
  "assignCallerUserRole": Func([Principal2, UserRole], [], []),
  "assignStaffRole": Func([Principal2], [], []),
  "claimAdminSeed": Func([Text], [Bool], []),
  "clockIn": Func([Text, Text, Text], [Nat], []),
  "clockOut": Func([Text], [Bool], []),
  "createJob": Func(
    [Text, Text, Text, Float64, Text],
    [Nat],
    []
  ),
  "createStaffAccount": Func([Text, Text, Text], [Bool], []),
  "deactivateStaffAccount": Func([Text, Bool], [], []),
  "deleteJob": Func([Nat], [], []),
  "deleteStaffAccount": Func([Text], [], []),
  ...
  "getStaffAttendance": Func([Text], [Vec(AttendanceLog)], ["query"]),
  "getUserProfile": Func(
    [Principal2],
    [Opt(UserProfile)],
    ["query"]
  ...
  "isStaffClockedIn": Func([Text], [Bool], ["query"]),
  "isUserStaff": Func([Principal2], [Bool], ["query"]),
  "listAllApplications": Func(
    [],
    [Vec(Tuple(Nat, Application))],
    ["query"]
  ),
  "listAllAttendanceLogs": Func([], [Vec(AttendanceLog)], ["query"]),
  "listAllDirectApplications": Func(
    [],
    [Vec(Tuple(Nat, DirectApplication))],
    ["query"]
  ),
  "listAllUsers": Func(
    [],
  ...
  "listApplicationsForJob": Func(
    [Nat],
    [Vec(Tuple(Nat, Application))],
    ["query"]
  ),
  "listJobs": Func([], [Vec(Tuple(Nat, Job))], ["query"]),
  "listMyApplications": Func(
    [],
    [Vec(Tuple(Nat, Application))],
    ["query"]
  ),
  "listStaffAccounts": Func([], [Vec(StaffAccountInfo)], ["query"]),
  "removeStaffRole": Func([Principal2], [], []),
  "saveCallerUserProfile": Func([UserProfile], [], []),
  "submitDirectApplication": Func(
    [Text, Text, Text, Text],
    [Nat],
    []
  ),
  "updateApplicationStatus": Func([Nat, ApplicationStatus], [], []),
  "updateDirectApplicationStatus": Func(
    [Nat, ApplicationStatus],
    [],
    []
  ),
  "listDirectApplicationsWithCredentials": Func(
    [Text, Text],
    [Opt(Vec(Tuple(Nat, DirectApplication)))],
    ["query"]
  ),
  "updateDirectApplicationStatusWithCredentials": Func(
    [Text, Text, Nat, ApplicationStatus],
    [Bool],
    []
  ),
  "verifyStaffLogin": Func([Text, Text], [Opt(StaffLoginResult)], ["query"]),
  "requestPasswordResetOTP": Func([Text], [Bool], []),
  "verifyOTPAndResetPassword": Func([Text, Text, Text], [Bool], []),
  "listPendingOTPs": Func([], [Vec(Record({ "userId": Text, "otp": Text }))], ["query"])
});
